...
plugin_identifier = "uiprototype_testplugin"

# The plugin's python package, should be "octoprint_<plugin identifier>", has to be unique
plugin_package = "octoprint_uiprototype_testplugin"

# The plugin's human readable name. Can be overwritten within OctoPrint's internal data via __plugin_name__ in the
# plugin module
plugin_name = "UI Prototype Test Plugin"
...
# module
plugin_description = """A basic test plugin for the ui prototype plugin."""
...
plugin_url = "https://github.com/OctoPrint/OctoPrint-UiPrototype-TestPlugin"
